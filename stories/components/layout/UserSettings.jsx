            ...
            <div className={Styles['nav-userdropdown']} onClick={this.toggleDropdown}>
                <p>
                    ...
                    <span className={Styles.icon}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 54 45" className={Styles.caret}><path d="M20.66233 26.5137c.73877.82086 1.94216.81464 2.67534 0l6.32466-7.0274C30.4011 18.66544 30.10738 18 29.0049 18H14.9951c-1.10187 0-1.3906.67166-.65743 1.4863l6.32466 7.0274z" fill="#b3b3b3" fillRule="evenodd"/></svg>
                    </span>
                </p>
